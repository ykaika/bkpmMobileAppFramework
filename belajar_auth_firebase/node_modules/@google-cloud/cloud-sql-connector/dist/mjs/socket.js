...
export function validateCertificate(instanceInfo, serverCaMode, dnsName) {
...
export function getSocket({ ephemeralCert, host, port, instanceInfo, privateKey, serverCaCert, serverCaMode, dnsName, }) {
    const socketOpts = {
        host,
        port,
